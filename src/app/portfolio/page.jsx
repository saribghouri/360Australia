...
export default function PortfolioPage() {
  ...
  const allImages = [
    ...
    { src: "/Minimalist Website Launch Computer Mockup Instagram Post.png", category: "graphics", alt: "Graphics Design Project 2" },
    { src: "/Minimalist Website Launch Computer Mockup Instagram Post.png", category: "graphics", alt: "Graphics Design Project 3" },
    { src: "/Minimalist Website Launch Computer Mockup Instagram Post.png", category: "graphics", alt: "Graphics Design Project 4" },
    { src: "/Minimalist Website Launch Computer Mockup Instagram Post.png", category: "graphics", alt: "Graphics Design Project 5" },
  ]

  // Define the desired display names for each category
  ...
  useEffect(() => {
    ...
    // Animation for Website Development Section images
    gsap.fromTo(
      websiteSectionRef.current.querySelectorAll(".portfolio-image"),
      { opacity: 0, scale: 0.9 },
      {
        opacity: 1,
        scale: 1,
        ...
        ease: "back.out(1.7)",
        scrollTrigger: {
          trigger: websiteSectionRef.current,
          start: "top 75%",
          toggleActions: "play none none reverse",
        },
      },
    )
    // Animation for Mobile App Development Section images
    gsap.fromTo(
      mobileSectionRef.current.querySelectorAll(".portfolio-image"),
      { opacity: 0, scale: 0.9 },
      {
        opacity: 1,
        scale: 1,
    ...
    // Animation for Graphics Design Section images
    gsap.fromTo(
      graphicsSectionRef.current.querySelectorAll(".portfolio-image"),
      { opacity: 0, scale: 0.9 },
      {
        opacity: 1,
        scale: 1,
        ...
        ease: "back.out(1.7)",
        scrollTrigger: {
          trigger: graphicsSectionRef.current,
          start: "top 75%",
          toggleActions: "play none none reverse",
        },
      },
      ...
      <section className="mb-12 w-full mt-[90px]" ref={ref}>
        ...
        <div className="grid grid-cols-1  sm:grid-cols-2 lg:grid-cols-3  gap-10">
          {filteredImages.map((image, index) => (
            <div
              key={index}
              className="relative group cursor-pointer testomnial-shadows overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-transform duration-300 hover:scale-105 portfolio-image"
      ...
      <div className="flex flex-col justify-center items-center w-full min-h-screen">
        <main className="flex-1 max-w-[100%] flex justify-center  md:py-20 ">
          <div className="max-w-[80%] flex justify-center flex-col items-center px-4 md:px-6">
            ...
            {renderImageGallery("graphics", graphicsSectionRef)}
          </div>
        </main>
