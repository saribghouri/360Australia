      ...
      <section className="bg-black text-white  md:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-[90%] mx-auto">
            ...
            <div className="max-w-8xl first-section mx-auto relative z-10 mt-[110px]">
                        <div className="flex w-full sm:w-[80%] md:w-[60%] lg:w-[16%] items-start mr-[40px] ml-[-80px] lg:ml-[-10px] mt-28 sm:mt-12 md:mt-16 lg:mt-[140px] justify-center  px-4">
      <Breadcrumb
        items={[
          {
            title: (
          ...
          <section className="bg-transparent mt-[10px] text-white py-13 px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="space-y-6">
              <h2 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight uppercase">
                Our <span className="text-teal-400">commitment</span>
              </h2>
            </div>
