...
export function CustomSelect({ id, value, onChange, onFocus, onBlur, options, placeholder, className, ...props }) {
    ...
    <DropdownMenu open={isOpen} onOpenChange={handleOpenChange}>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          {...props}
        >
          <span className={value ? "text-white" : "text-gray-300"}>{displayValue}</span>
          <ChevronDown
