  ...
  return (
    <div className="w-full  ">
      <section className="relative min-h-screen overflow-hidden bg-black w-full">
        <div className="absolute inset-0 w-full h-full mt-[110px] ">
          <video
            autoPlay
            muted
            loop
          ...
          >
            <source
              src="/WhatsApp Video 2025-07-10 at 4.58.26 AM.mp4"
              type="video/mp4"
            />
              ...
              <div className="space-y-4 sm:space-y-6 pt-6 sm:pt-8">
                ...
                >
                  <h2 className="text-white text-xl  sm:text-3xl uppercase font-bold">
                    The Process Behind
                    <br />
                    <span className="text-teal-500 text-4xl sm:text-6xl uppercase">
                      {" "}
                      Your Growth
                    </span>
                  </h2>
                ...
                <div className="space-y-4 max-w-3xl w-full">
                  {testimonials.map((testimonial, index) => {
                    ...
                    const hoverColorRgba = isGreenCard
                      ? "rgba(0, 0, 0, 0.2)"
                      : "rgba(16, 212, 196, 0.2)";
