...
export default function WhatsAppButton() {
  ...
  const whatsappNumber = "61412345678" // Example: Australian number
  const message = "Hello! I'm interested in your services from 360 Australia."
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="absolute right-full mr-3 px-3 py-2 bg-gray-800 text-white text-sm rounded-lg whitespace-nowrap shadow-lg"
        >
