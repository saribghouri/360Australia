  ...
  const services = [
    {
      icon: Search,
      title: "SEO",
      description: "Make it easier for people to find your business on Google.",
    ...
    },
    {
      ...
      description:
        "Reach the right customers with targeted ads on Google and beyond.",
      borderColor1: "border-white",
      borderColor2: "border-teal-300",
    },
    {
      ...
      description:
        "Build your brand and grow your audience across social platforms.",
      borderColor1: "border-white",
      borderColor2: "border-teal-300",
    },
    {
      icon: Mail,
      title: "Email & Contents   Marketing",
      description:
        "Keep customers engaged with helpful emails and quality content.",
      borderColor1: "border-white",
      borderColor2: "border-teal-300",
    },
    {
      ...
      description:
        "Attract new customers who are already interested in your services. ",
      borderColor1: "border-white",
      borderColor2: "border-teal-300",
    },
  ];
  ...
  return (
    <>
      {/* <div className="mt-[110px]">
       ...
       <div className="flex w-full sm:w-[80%] md:w-[60%] lg:w-[46%] mt-8 sm:mt-12 md:mt-16 lg:mt-[70px]  ml-[-50px] lg:ml-[-30px]  justify-center items-center ">
      <Breadcrumb
        items={[
          {
            title: (
      ...
      >
        ...
        <div className="container px-4 md:px-6 text-start max-w-9xl mx-auto mb-20">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
            ...
            <h1 className="text-teal-400 mt-[10px]"> MARKETING </h1>
          </h1>
          <p className="text-lg md:text-xl text-white leading-relaxed">
            At 360 Australia, we help your brand get noticed, connect with more
            people, and grow online. From SEO to social media and Google ads, we
            bring in the clicks, boost your reach, and make sure your business
