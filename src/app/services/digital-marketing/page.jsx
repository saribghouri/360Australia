...
export default function DigitalSolutionsSection() {
 ...
 const services = [
    ...
    },
    {
      ...
      description: "Reach the right customers with targeted ads on Google and beyond.",
      borderColor1: "border-white",
      borderColor2: "border-teal-300",
    },
    {
    ...
    },
    {
      ...
      description: "Keep customers engaged with helpful emails and quality content.",
      borderColor1: "border-white",
      borderColor2: "border-teal-300",
    },
    {
      ...
      description: "Attract new customers who are already interested in your services. ",
      borderColor1: "border-white",
      borderColor2: "border-teal-300",
    },
  ]
        ...
        <div className="container px-4 md:px-6 text-start max-w-9xl mx-auto mb-20">
         ...
         <h1 className="text-teal-400 mt-[10px]"> MARKETING </h1>
          ...
          <p className="text-lg md:text-xl text-white leading-relaxed">
            At 360 Australia, we help your brand get noticed, connect with more people, and grow online. From SEO to social media and Google ads, we bring in the clicks, boost your reach, and make sure your business stands out where it counts.
          ...
          {services.map((service, index) => (
            ...
            >
             <div className={`p-[7px] border-3 rounded-full h-[115px] testomnial-shadows ${service.borderColor1}`}>
              ...
              <h3 className="text-3xl font-bold mb-3 mt-15">{service.title}</h3>
